...
export function variableBytes(value) {
...
export function readVariable(bytes, cursor) {
  let value = 0;
  let byte;
  do {
...
export function importMidi(file, renderNotes) {
